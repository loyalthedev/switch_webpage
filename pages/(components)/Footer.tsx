const Footer = () => {
  return (
    <footer className='w-full bg-[#121212] border-t border-border'>
      <div className='container mx-auto px-4 sm:px-6 md:px-12 py-6 sm:py-8'>
        <div className='flex flex-col md:flex-row items-start md:items-center justify-between gap-6 md:gap-8'>
          {/* Left Section */}
          <div className='w-full md:w-auto'>
            <h3 className='text-2xl sm:text-3xl font-bold tracking-wide font-train text-foreground mb-1'>
              SWITCH
            </h3>
            <p className='text-sm sm:text-base font-bold text-muted-foreground mb-3 sm:mb-4'>
              Your everyday App
            </p>
        ...
        {/* Bottom Bar */}
        <div className='mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4'>
